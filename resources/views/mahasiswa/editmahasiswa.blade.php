    ...
    <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="post">
        ...
        <div class="card-body ">
            <div class="mb-3 row ">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" type="text" class="form-control @error('nim') is-invalid @enderror " name="nim" required value="{{ old('nim', $mahasiswa->nim) }}">
                    @error('nim')
            ...
            <div class="mb-3 row">
                <label for="formGroupExampleInput2" class="form-label font-weight-bold col-sm-2 col-form-label">Nama
                    Mahasiswa</label>
                <div class="col-sm-10">
                    <input autocomplete="off" name="nama_mahasiswa" type="text" class="form-control @error('nama_mahasiswa') is-invalid @enderror " id="formGroupExampleInput2" required value="{{ old('nama_mahasiswa', $mahasiswa->nama_mahasiswa) }}">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" name="jurusan" type="text" class="form-control @error('jurusan') is-invalid @enderror " id="formGroupExampleInput2" required value="{{ old('jurusan', $mahasiswa->jurusan) }}">
                    @error('jurusan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input autocomplete="off" name="asal_instansi" type="text" class="form-control @error('asal_instansi') is-invalid @enderror" id="asal_instansi" required value="{{ old('asal_instansi', $mahasiswa->asal_instansi) }}">
                    @error('asal_instansi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
