...
<div class="card shadow mb-4">
    <div class="card-header py-3 justify-content-between d-flex">
        ...
        <a href="{{ route('user.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm-w-20 text-white-50 mr-2 "></i>Tambah Data</a>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btnHapus btn-danger btn-circle btn-sm border-0" href="#" data-toggle="modal" data-target="#hapusModal" data-id="{{ $item->id }}">
